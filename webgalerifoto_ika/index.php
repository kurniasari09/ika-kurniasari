...
<body>
    ...
    <header>
        <div class="container">
        <h1><a href="index.php">WEB GALERI FOTO IKA</a></h1>
        <ul>
    ...
    <div class="container">
       ...
       <div class="box">
          <?php
              $foto = mysqli_query($conn, "SELECT * FROM tb_image WHERE image_status = 1 ORDER BY image_id DESC LIMIT 10");
    ...
    <!-- footer -->
     <footer>
        <div class="container">
            <small>SELAMAT DATANG &copy; 2024 - Web Galeri Foto.</small>
        </div>
    </footer>
</body>
</html>